      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-3xl font-bold text-slate-800 mb-2">Seu carrinho está vazio</h1>
            <p className="text-slate-600 mb-8 text-pretty">
              Parece que você ainda não adicionou nenhum item ao seu carrinho. Explore nossos produtos e encontre algo especial!
            </p>
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Carrinho de Compras</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-slate-800">Itens</h2>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-24 rounded-xl shadow-lg border-slate-200">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  {shipping > 0 && (
                    <p className="text-xs text-slate-500">Frete grátis em compras acima de R$ 199,00</p>
                  )}
                </div>
                <Separator />
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500 text-center">Parcelamento em até 12x sem juros</p>
                </div>
