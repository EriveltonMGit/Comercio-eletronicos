...
// Importa só o message do Ant Design
...
export function ProductCard({ product }: ProductCardProps) {
 ...
 const handleAddToCart = () => {
  if (!inStock) {
    console.log("➡️ Chamando message.error: fora de estoque");
  ...
  console.log("✅ Chamando message.success: produto adicionado ao carrinho");
  message.success(`${product.name} foi adicionado ao carrinho!`);
};

const handleToggleFavorite = () => {
  if (isFavorite) {
    dispatch(removeFromFavorites(product.id.toString()));
    console.log("❌ Chamando message.success: produto removido dos favoritos");
    message.success(`${product.name} foi removido dos favoritos.`);
  } else {
    dispatch(
      addToFavorites({
        id: product.id.toString(),
    ...
    console.log("💖 Chamando message.success: produto salvo nos favoritos");
    message.success(`${product.name} foi salvo nos seus favoritos!`);
  }
};
