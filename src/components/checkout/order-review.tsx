...
import { notification } from "antd" // Substitui o toast pelo Ant Design Notification
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      notification.success({
        ...
        description: `Seu pedido #${orderId} foi concluído com sucesso.`,
        placement: 'topRight',
      });

      dispatch(setCurrentStep(5)) // Assumindo que a confirmação é o passo 5
    } catch (error) {
