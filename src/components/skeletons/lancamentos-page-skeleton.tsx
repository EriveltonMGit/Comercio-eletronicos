// src/components/skeletons/lancamentos-page-skeleton.tsx

import React from 'react';
import { Card, CardContent } from '../ui/card';

export function LancamentosPageSkeleton() {
    return (
        <div className="animate-pulse">
            ...
            <section className="bg-gradient-to-br from-slate-200 to-slate-100 py-12 md:py-24">
                <div className="container mx-auto px-4 text-center">
                    <div className="h-6 w-32 bg-slate-300 rounded mb-4 mx-auto" /> {/* Badge */}
